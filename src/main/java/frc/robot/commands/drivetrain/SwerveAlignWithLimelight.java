...
public class SwerveAlignWithLimelight extends CommandBase {
    ...
    public SwerveAlignWithLimelight() {
        ...
        tyController = new PIDController(Drivetrain.TY_kP, Drivetrain.TY_kI, Drivetrain.TY_kD);
        ...
        tyController.setTolerance(Drivetrain.TY_ALLOWABLE_ERROR);
    }
    ...
    public void initialize() {
        ...
        // Shooter.getInstance().getMaster().selectProfileSlot(Shooter.SHOOTER_VELOCITY_SLOT, RobotMap.PRIMARY_INDEX);
        // Shooter.getInstance().getMaster().setNeutralMode(NeutralMode.Coast);
        // Shooter.getInstance().getMaster().configClosedloopRamp(Shooter.SHOOTER_RAMP_RATE);
    ...
    public void execute() {
        ...
        turn += translateX * Drivetrain.TX_VELOCITY_COMPENSATION;
        ...
        Shooter.getInstance().spinShooter(tyController.calculate(Limelight.getTy(), Shooter.TY_SETPOINT) * Shooter.MAX_SHOOTER_VELOCITY + translateY * Shooter.TY_VELOCITY_COMPENSATION);

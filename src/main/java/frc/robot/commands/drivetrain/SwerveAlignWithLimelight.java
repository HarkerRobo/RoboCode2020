...
public class SwerveAlignWithLimelight extends CommandBase {
    ...
    public void execute() {
        ...
        ChassisSpeeds speeds = ChassisSpeeds.fromFieldRelativeSpeeds(
            translateX, translateY, turn, Rotation2d.fromDegrees(Drivetrain.getInstance().getPigeon().getFusedHeading() - 90)
        );
    ...
    public boolean isFinished() {
        return txController.atSetpoint() && thorController.atSetpoint();
    }
